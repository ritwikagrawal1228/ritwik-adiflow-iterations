              ...
              <div className="flex flex-col gap-[35px] items-center justify-start mb-[72px] mt-[15px] w-[100%]">
                ...
                <div className="bg-white_A700 flex flex-col gap-[40px] items-center justify-start p-[48px] sm:px-[20px] md:px-[40px] rounded-[4px] shadow-bs w-[100%]">
                  ...
                  <div className="flex flex-col relative sm:w-[100%] w-[56%]">
                    <div
                      className="bg-cover bg-no-repeat flex h-[504px] items-center justify-start mx-[auto] rounded-[4px] w-[100%]"
                      style={{
                        backgroundImage: "url('images/img_group16121.png')",
                      }}
                    >
                      <div
                        className="bg-cover bg-no-repeat md:h-[377px] h-[504px] p-[62px] sm:px-[20px] md:px-[40px] relative w-[100%]"
                        style={{
                    ...
                    <Button
                      className="flex h-[80px] items-center justify-center mt-[-17px] mx-[auto] rounded-[50%] w-[80px] z-[1]"
                      size="3xlIcn"
