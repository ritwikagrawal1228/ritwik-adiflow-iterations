                ...
                <div className="bg-white_A700 flex items-center justify-start mt-[32px] p-[30px] sm:px-[20px] rounded-[4px] shadow-bs w-[100%]">
                  <div className="flex flex-col gap-[48px] items-center justify-start mb-[38px] w-[100%]">
                    ...
                    <div className="flex md:flex-col flex-row md:gap-[40px] items-start justify-between w-[100%]">
                      <div className="flex md:flex-1 flex-col gap-[32px] items-start justify-start pt-[4px] md:w-[100%] w-[15%]">
                      ...
                      <div className="flex md:flex-1 flex-col gap-[32px] items-start justify-start pt-[4px] md:w-[100%] w-[54%]">
